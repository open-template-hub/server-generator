[![Downloads](https://img.shields.io/npm/v/open-template-hub-server-generator?style=for-the-badge)](https://www.npmjs.com/package/open-template-hub-server-generator)
